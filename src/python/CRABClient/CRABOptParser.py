...
class CRABCmdOptParser(OptionParser, doc=""):
    ...
    def __init__(self, cmdconf):
        usage = "usage: %prog " + self.name + " [options] [args]"
        OptionParser.__init__(self, description = doc, usage = self.usage, add_help_option = True)
