    ...
    def __call__(self):
        ...
        while not stop:
            ...
            if cpexitcode == 0:
                ...
                returndict = {'status' : 'SUCCESS' , 'return' : ''}
                ...
                if 'Permission denied' in cperr or 'mkdir: cannot create directory' in cperr:
                    ...
                    returndict = {'status' : 'FAILED' , 'return' : 'Permission denied or cannot create directory'}
                    stop = True
                    ...
                    returndict = {'status' : 'FAILED' , 'return' : 'timeout error'}
                    stop = True
